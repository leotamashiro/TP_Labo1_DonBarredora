...
int jugar()
{
    ...
    */
    ...
    int rondaGanadaJugador=0, rondaGanadaElemtoJugador=0; // contadores de puntos
    int rondaGanadaCPU=0, rondaGanadaElementoCPU=0; // contadores de puntos
